...
module.exports = function(app){
  ...
  //文章数据
  const articleData = [
    {btype:'原创',btitle:'文档标题5',bcontent:'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.',
    bimage:'./static/img/index05.jpg',bview:119,blabel:['mongodb','VUE'],blike:61},
...
// 首页文章列表
  app.get('/api/getArticle',(req,res)=>{
    dbAPI.article.find({},(request,result)=>{res.send(result)}).limit(req.query.count?parseInt(req.query.count):'')
  })
